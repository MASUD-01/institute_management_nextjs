...
import LayoutMenu from "../component/LayoutMenu/LayoutMenu";
import LayoutDrawer from "../component/LayoutDrawer/LayoutDrawer";
import ResizableSidebar from "@/components/utilities/ResizableSidebar";
import LayoutHeader from "../component/LayoutHeader/LayoutHeader";
import LayoutFooter from "../component/LayoutFooter/LayoutFooter";
  ...
  return (
    <Layout hasSider style={{ minHeight: "100vh" }}>
      <Layout.Sider
        ...
        collapsed={collapsed}
      >
        {!xs && <LayoutMenu collapsed={collapsed} />}
